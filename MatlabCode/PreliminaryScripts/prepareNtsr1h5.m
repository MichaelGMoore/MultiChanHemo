% Prepare Ntsr1 GFP data as .h5 with simple schema
...
folder = '/home/mmoore/Optical_Data_Analysis/Data/Widefield/Matt_Valley/GFP_Mice/Ntsr1/Raw';
fdir = dir(folder);
fdir = fdir(3:end);
...
for m = 1:length(fdir)
    ...
    outFolder = '/home/mmoore/Dropbox/Work/projects/WFOM_MultiChanHemo/Version3/PreliminaryScripts/Ntsr1';
    ...
    h5writeatt(fname,'/','CreName','Ntsr1'); % this is not be a required field
